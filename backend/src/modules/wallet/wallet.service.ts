...
export class WalletService {
  ...
  async updateWallet(id: string, data: any) {
    return this.repository.update(id, data);
      ...
      const updatedWallet = await this.repository.addCoin(
        walletId,
        amount
      );
      ...
      // Temporary Coin Collector check
      // পরে আমরা Achievement Engine দিয়ে এটা replace করব
      if (updatedWallet.coinBalance >= 10000) {
        // আপাতত এখানে কিছু করব না
      }
